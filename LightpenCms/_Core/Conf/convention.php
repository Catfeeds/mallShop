...
return  array(
    ...
    'APP_GROUP_LIST'        => 'Home,Admin,User,User2,Wap,Customer,Helper,HelperApp,HCms,Dms,MBWap,User5,Group',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
    ...
    //'DEFAULT_FILTER'        =>  'trim,htmlspecialchars,strip_tags', // 默认参数过滤方法 用于 $this->_get('变量名');$this->_post('变量名')...
