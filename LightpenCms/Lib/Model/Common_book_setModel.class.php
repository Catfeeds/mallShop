<?php
class Common_book_setModel extends Model{
	...
	public function getCommonBookSetList($where){
		return M('common_book_set')->where($where)->field('id,companyid,name,scannum,bookinfo,isshow')->order('id DESC')->select();
	}
}