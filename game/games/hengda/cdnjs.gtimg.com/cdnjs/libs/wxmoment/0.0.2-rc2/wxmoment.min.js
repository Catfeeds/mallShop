    ...
    require.register("./lib/underscore",
        function(t, e) { (function() {
            ...
            g.template = function(t, e, n) { ! e && n && (e = n),
                ...
                t.replace(r,
                    function(e, n, r, a, s) {
                        return o += t.slice(i, s).replace(C, _),
                            i = s + e.length,
    ...
    require.register("./lib/zepto",
        function(t, e) {
            var n = require("lib/zepto/touch.js"
                    /*tpa=http://cdnjs.gtimg.com/cdnjs/libs/wxmoment/0.0.2-rc2/lib/zepto/touch.js*/
                ),
                r = function() {
                    function t(t) {
                    ...
                    function h(t) {
                        var e, n;
                        return O[t] || (e = N.createElement(t), N.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), O[t] = n),
                            O[t]
                    }
                    function p(t) {
                    ...
                    return Y.matches = function(t, e) {
                        ...
                        Y.fragment = function(t, e, n) {
                            var r, i, a;
                            return D.test(t) && (r = T(N.createElement(RegExp.$1))),
                                r || (t.replace && (t = t.replace(P, "<$1></$2>")), e === x && (e = L.test(t) && RegExp.$1), e in z || (e = "*"), a = z[e], a.innerHTML = "" + t, r = T.each(C.call(a.childNodes),
                                function() {
                                    a.removeChild(this)
                                })),
                                o(n) && (i = T(r), T.each(n,
                        ...
                        Y.init = function(t, n) {
                            var r;
                            if (!t) return Y.Z();
                            if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && L.test(t)) r = Y.fragment(t, RegExp.$1, n),
                                t = null;
                            else {
                                ...
                                if ($(t)) r = s(t);
                                    ...
                                    t = null;
                                else if (L.test(t)) r = Y.fragment(t.trim(), RegExp.$1, n),
                                    t = null;
                                else {
                                    if (n !== x) return T(n).find(t);
                                    r = Y.qsa(N, t)
                        ...
                        T.fn = {
                            ...
                            ready: function(t) {
                                return G.test(N.readyState) && N.body ? t(T) : N.addEventListener("DOMContentLoaded",
                                    function() {
                                        t(T)
                                    },
                                    !1),
                            ...
                            toggleClass: function(t, e) {
                                return t ? this.each(function(n) {
                                    var r = T(this),
                                        i = m(this, t, n, y(this));
                                    i.split(/\s+/g).forEach(function(t) { (e === x ? !r.hasClass(t) : e) ? r.addClass(t) : r.removeClass(t)
                                    })
                                }) : this
                            },
            ...
            window.Zepto = r,
                ...
                function(t) {
                    ...
                    function c(e, n) {
                        return (n || !e.isDefaultPrevented) && (n || (n = e), t.each(A,
                            function(t, r) {
                                var i = n[t];
                                e[t] = function() {
                                    return this[r] = x,
                            ...
                            if (T.setRequestHeader = x, T.onreadystatechange = function() {
                                if (4 == T.readyState) {
                                    ...
                                    if (T.status >= 200 && T.status < 300 || 304 == T.status || 0 == T.status && "file:" == E) {
                                        p = p || l(i.mimeType || T.getResponseHeader("content-type")),
                                            e = T.responseText;
                                        try {
