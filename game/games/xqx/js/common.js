...
~function(bt) {
    ...
    var loading = function(d, e) {
        if (d > 0x0 && !b) {
            ...
            b.html('<table><tr><td><img class="bt-img" src="images/155122_6492.png" /><div class="bt-text"></div></td></tr></table>');
...
~function(bt) {
    ...
    onlyH.prototype = {
        ...
        getScreenOption: function() {
            return {
                id: "bt-h-scrren",
                html: "<table><tr><td><img class='bt-h-screen-img' src='images/155217_9186.jpg' /></td></tr></table>",
                time: 0x0,
                lockId: "bt-hide-lock"
            }
        },
    ...
    onlyH.prototype, {
        ...
        getScreenOption: function() {
            return {
                id: "bt-v-scrren",
                html: "<table><tr><td><img class='bt-v-screen-img' src='images/155301_2850.jpg' /></td></tr></table>",
                time: 0x0,
                lockId: "bt-hide-lock"
            }
        }
...
~function(bt) {
    ...
    function tip() {
        var c = bt.advertisement({
            id: b,
            html: "<img class='bt-play-share-tip-img' src='images/shareimg.jpg' />",
            time: 0x0
        });
        c.show();
        setTimeout(function() {
