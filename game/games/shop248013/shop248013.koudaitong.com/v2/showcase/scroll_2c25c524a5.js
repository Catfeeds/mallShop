define("wap/showcase/modules/swp/utils", ["require"],
function(t) {
    function e() {
        this.__events = {}
    }
...
define("wap/showcase/modules/swp/input", ["require", "./utils"],
function(t) {
    function e(t) {
...
define("wap/showcase/modules/swp/anm_elem", ["require", "./utils"],
function(t) {
    function e(t, e) {
    ...
    n(e.prototype, {
        ...
        to: function(t) {
            ...
            var i = new $.Deferred;
            return e.css(t).on("transitionend webkitTransitionEnd",
            function s() {
...
define("wap/showcase/modules/swp/scroll", ["require", "./utils", "./anm_elem"],
function(t) {
    function e(t, e) {
        n.apply(this, arguments),
        this.wrapElem = t,
    ...
    s(e.prototype, {
        init: function() {
            ...
            this.pages = [].map.call(this.pages,
            function(t) {
                return new a($(t), {
...
define("wap/showcase/modules/swp/anm_player", ["require", "./anm_elem"],
function(t) {
    function e() {
        this.init.apply(this, arguments),
        this.hasPlayed = !1
...
define("wap/showcase/modules/swp/main", ["require", "./utils", "./input", "./scroll", "./anm_player"],
function(t) {
    function e(t, e) {
        this.wrapElem = t,
        this.options = e
...
define("wap/showcase/modules/swp/resource_loader", ["require"],
function(t) {
    function e(t) {
        this.wrap = t
    }
    return e.prototype = {
        ...
        loadRes: function() {
            var t = this,
            e = [];
            return this.wrap.find(".js-res-load").each(function(i, n) {
                var s = $(this),
                a = new $.Deferred;
                t.loadImage(s, s.data("src"),
                function() {
                    a.resolve()
                }),
                e.push(a.promise())
...
define("wap/showcase/modules/scroll/lottery", ["require"],
function(t) {
...
function() {
    var t = {
        ...
        media_control: function() {
            this._audio && ($("video").length <= 0 || ($(this._audio).on("play",
            function() {
                $("video").each(function() {
...
define("wap/showcase/modules/scroll/media",
function() {}),
function(t) {
...
define("wap/showcase/modules/scroll/coffee",
function() {}),
require(["wap/showcase/modules/swp/main", "wap/showcase/modules/swp/resource_loader", "wap/showcase/modules/scroll/lottery", "wap/showcase/modules/scroll/media", "wap/showcase/modules/scroll/coffee"],
function(t, e, i, n) {
    function s(i) {
        this.wrap = i,
        ...
        this.coffeeAnimation = '<img src="' + _global.url.cdn_static + '/image/scroll/audio_widget_01@2x.png" />',
