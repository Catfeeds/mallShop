...
function initUI(_box){
	...
	/*start DWZ 整合 kindeditor
	$("textarea.kindeditor", $p).each(function () {
	    $.getScript('/Tpl/static/dwz/kindeditor/kindeditor-min.js', function () {
	        KindEditor.basePath = '/Tpl/static/dwz/kindeditor/kindeditor/';
	        var editor = KindEditor.create('textarea[name="content"]', {
	            uploadJson: '/Tpl/static/dwz/kindeditor/php/upload_json.php',
	            fileManagerJson: '/Tpl/static/dwz/kindeditor/php/file_manager_json.php',
