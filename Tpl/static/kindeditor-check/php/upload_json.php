...
$ext_arr = array(
	...
	'file' => array('doc', 'docx', 'xls', 'xlsx', 'pptx','ppt', 'html', 'txt', 'zip', 'rar', 'gz', 'bz2', 'csv','pem','png','rp','jpg','jpeg','prd','pdf','psd'),
);
...
if (empty($_FILES) === false) {
	...
	if ($file_size > $max_size) alert("抱歉，上传失败。错误原因：请上传小于等于50MB的文件");
