...
<title>{lanrain::L('RedirectPrompt')}</title>
...
<div class="system-message">
	<h2 class="title">{lanrain::L('Prompt')}</h2>
	<div class="bd">
	...
	<p class="detail"></p>
	<div class="jump">{lanrain::L('PageRedirect1')}<a id="href" href="<?php echo($jumpUrl); ?>">{lanrain::L('PageRedirect2')}</a> {lanrain::L('AwaitTime')}： <b id="wait"><?php echo($waitSecond); ?></b>
	</div>
</div>
