    ...
    <div class="inner-cont clearfix">
		<div class="ui top green attached segment vote-top">
			  <h1 class="vote-title"><?=$xuanzezu[16]?></h1>
			    <h1 class="vote-canyu">共<a class="ui orange label" id="sumvote">0</a>人参与</h1>
			  <h3 class="vote-title vote-titlefu">微信关注【<?=$wallconf['publicnum']?>】，发送【<?=$voteplug['keyword']?>】即可参与投票互动！</h3>
					</div>
