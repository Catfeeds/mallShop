...
<div class="container" style="width:60%">
        <div class="login-screen">
          ...
          <div class="login-form">
            ...
            <a class="btn btn-primary btn-lg btn-block" href="javascript:void(0);" id="login-submit">登  录</a>
            <a class="login-link" href="javascript:void(0);" target="_blank"><img src="images/logo_vote.png"/></a>
          </div>
        </div>
</div>
</body>
