  $(function(){
	...
	var cj_id = 0;  //参与抽奖人数
	var cj_jadge = 1;  
	var cj_retime = 0;  //重来的次数
	var cj_per= new Array();   //参与抽奖人数的数组
	var cjstart_btn = $(".startLotteryBtn");  //开始抽奖按钮
		   ...
		   cj_per= new Array(); 
			...
			if(json){
				 $.each(json, function(i,v){
					cj_per.push(new Array(v['id'],v['avatar'],v['nickname'],v['from']));  //二维数组  抽奖的人数
				});
