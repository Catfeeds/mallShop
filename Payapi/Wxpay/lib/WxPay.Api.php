...
class WxPayApi
{
    ...
    public function __construct($options)
    {
        ...
        $this->apiclientKey = isset($options['apiclientKey'])?$_SERVER['DOCUMENT_ROOT'].$options['apiclientKey']:$_SERVER['DOCUMENT_ROOT'].'/Payapi/Wxpay/cert/apiclient_key.pem';
        $this->apiclientCert = isset($options['apiclientCert'])?$_SERVER['DOCUMENT_ROOT'].$options['apiclientCert']:$_SERVER['DOCUMENT_ROOT'].'/Payapi/Wxpay/cert/apiclient_cert.pem';
    }
	...
	public function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$WxPayResults = new WxPayResults(array('key'=>$this->key));
	...
	{
		if(!$inputObj->IsProduct_idSet()){   // 判断订单号是否存在
	...
	{		
		...
		if($useCert == true){
			...
			/* echo $this->apiclientKey.'<br/>';
			echo $this->apiclientCert;
			exit(); */
			curl_setopt($ch,CURLOPT_SSLCERT,$this->apiclientCert);
			//curl_setopt($ch,CURLOPT_SSLCERT, '/www/wwwroot/weixin.lightpen.cn/Payapi/Wxpay/cert/apiclient_key.pem');
			//curl_setopt($ch,CURLOPT_SSLCERT, '/www/wwwroot/weixin.lightpen.cn/Uploads/1217/file/20160704/20160704154132_90057.pem');
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY,$this->apiclientKey );
			//curl_setopt($ch,CURLOPT_SSLKEY,'/www/wwwroot/weixin.lightpen.cn/Payapi/Wxpay/cert/apiclient_cert.pem');
			//curl_setopt($ch,CURLOPT_SSLKEY,'/www/wwwroot/weixin.lightpen.cn/Uploads/1217/file/20160704/20160704154138_59327.pem');
		}
		//post提交方式
